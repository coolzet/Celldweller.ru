...
if($connect->connect_error) die("Fatal Error"); 
	...
	if ($newsCount > $newsLimit) {
		...
		if ($previous 		> 0) {
			echo '<a  id="img_go"href="allblog.php?page=' . $previous . '"><img src="https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200" height="80px" style="transform: rotate(180deg);">  </a>';
		}
		
		if ($next <= $pageCount) {
			echo '<a id="img_back" href="allblog.php?page=' . $next . '"><img src="https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200" height="80px"></a>';
		}
		if($page == 1){
			echo "<a href='allblog.php?page=" . $newsCount . "' class='to_end_all_news'><img src=\"https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200\" height=\"80px\" ><img id='first_img_end'src=\"https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200\" height=\"80px\"></a>";
		}
		if($page > 2){
			echo "<a href='allblog.php?page=1' id='to_start_all_news'><img src=\"https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200\" height=\"80px\" style=\"transform: rotate(180deg);\"><img id='first_img'src=\"https://avatars.mds.yandex.net/get-pdb/753890/0504288c-f993-489a-9277-e0ba2a8a7037/s1200\" height=\"80px\" style=\"transform: rotate(180deg);\"></a>";
		}
	}
?></div></div></div>
